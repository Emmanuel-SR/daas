...
OR P.PAYMENT_DATE BETWEEN '2020-02-01' AND '2020-02-29'
)
...
UNION
SELECT DISTINCT C.* FROM [DATA].[CREDITOS_COMPARTAMOS] C
INNER JOIN DATA.PAGOS P ON P.CREDIT_CODE = C.CREDIT_CODE
WHERE P.PAYMENT_DATE BETWEEN '2020-07-01' AND '2020-07-31'
