...
BEGIN
  ...
  ALTER TABLE DATA.HIST_ASSIGNMENT_1_PREV ALTER COLUMN PERIOD_CODE CHAR(6) NOT NULL;
  ...
  ALTER TABLE DATA.HIST_ASSIGNMENT_1_PREV ADD CONSTRAINT UQ_HISTASGMT1_PERIODCODE_CREDITKEY_PREV UNIQUE (PERIOD_CODE, CREDIT_KEY);
  ...
  EXEC sp_rename 'DATA.UQ_HISTASGMT1_PERIODCODE_CREDITKEY', 'UQ_HISTASGMT1_PERIODCODE_CREDITKEY_OLD';
  ...
  EXEC sp_rename 'DATA.UQ_HISTASGMT1_PERIODCODE_CREDITKEY_PREV', 'UQ_HISTASGMT1_PERIODCODE_CREDITKEY';
