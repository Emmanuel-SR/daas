...
BEGIN
  ...
  LEFT JOIN DATA.HIST_ASSIGNMENT H
    ON LEFT(H.DATE_KEY,6) = @PERIOD AND C.CREDIT_KEY = H.CREDIT_KEY
  ...
  WHERE LEFT(P1.PAYMENT_DATE,6) <> @PERIOD
  ...
  ALTER TABLE DATA.FACT_PAYMENT_1_PREV ALTER COLUMN PAYMENT_DATE INTEGER NOT NULL;
  ...
  ALTER TABLE DATA.FACT_PAYMENT_1_PREV ADD CONSTRAINT FK_FACTPAY1_DIMDATE_PYMNTDATE_PREV FOREIGN KEY (PAYMENT_DATE)
    REFERENCES DATA.DIM_DATE(DATE_KEY);
  ALTER TABLE DATA.FACT_PAYMENT_1_PREV ADD CONSTRAINT FK_FACTPAY1_DIMCRED_CREDITKEY_PREV FOREIGN KEY (CREDIT_KEY)
    REFERENCES DATA.DIM_CREDIT(CREDIT_KEY);
  ALTER TABLE DATA.FACT_PAYMENT_1_PREV ADD CONSTRAINT FK_FACTPAY1_DIMCUR_CURRENCYKEY_PREV FOREIGN KEY (CURRENCY_KEY)
  ...
  EXEC sp_rename 'DATA.FK_FACTPAY1_DIMDATE_PYMNTDATE', 'FK_FACTPAY1_DIMDATE_PYMNTDATE_OLD';
  EXEC sp_rename 'DATA.FK_FACTPAY1_DIMCRED_CREDITKEY', 'FK_FACTPAY1_DIMCRED_CREDITKEY_OLD';
  EXEC sp_rename 'DATA.FK_FACTPAY1_DIMCUR_CURRENCYKEY', 'FK_FACTPAY1_DIMCUR_CURRENCYKEY_OLD';
  ...
  EXEC sp_rename 'DATA.FK_FACTPAY1_DIMDATE_PYMNTDATE_PREV', 'FK_FACTPAY1_DIMDATE_PYMNTDATE';
  EXEC sp_rename 'DATA.FK_FACTPAY1_DIMCRED_CREDITKEY_PREV', 'FK_FACTPAY1_DIMCRED_CREDITKEY';
  EXEC sp_rename 'DATA.FK_FACTPAY1_DIMCUR_CURRENCYKEY_PREV', 'FK_FACTPAY1_DIMCUR_CURRENCYKEY';
